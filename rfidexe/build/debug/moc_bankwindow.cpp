...
QT_MOC_LITERAL(1, 11, 16), // "bankClosedSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 21) // "on_pushButton_clicked"

    },
    "bankwindow\0bankClosedSignal\0\0"
...
void bankwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->bankClosedSignal(); break;
        ...
        {
            using _t = void (bankwindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&bankwindow::bankClosedSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void bankwindow::bankClosedSignal()
{
