...
void Rfid::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Rfid::*)(short );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Rfid::signaali)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Rfid::sendCardNumberToExe)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Rfid::sendCardNumberToExe(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
